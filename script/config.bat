...
set QEMU_NET_OPTION=%QEMU_NET_OPTION%,hostfwd=tcp:127.0.0.1:22-:22
set QEMU_NET_OPTION=%QEMU_NET_OPTION%,hostfwd=tcp:127.0.0.1:80-:80
set QEMU_NET_OPTION=%QEMU_NET_OPTION%,hostfwd=tcp:127.0.0.1:443-:443
set QEMU_NET_OPTION=%QEMU_NET_OPTION%,hostfwd=tcp:127.0.0.1:2222-:2222
set QEMU_NET_OPTION=%QEMU_NET_OPTION%,hostfwd=tcp:127.0.0.1:2375-:2375
set QEMU_NET_OPTION=%QEMU_NET_OPTION%,hostfwd=tcp:127.0.0.1:8000-:8000
set QEMU_NET_OPTION=%QEMU_NET_OPTION%,hostfwd=tcp:127.0.0.1:8080-:8080
set QEMU_NET_OPTION=%QEMU_NET_OPTION%,hostfwd=tcp:127.0.0.1:9000-:9000
set QEMU_NET_OPTION=%QEMU_NET_OPTION%,hostfwd=tcp:127.0.0.1:10000-:10000
